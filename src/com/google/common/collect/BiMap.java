 ...
 * as this bimap but with its keys and values reversed.
 *
...
public interface BiMap<K, V> extends Map<K, V> {
   ...
   * {@code key}) before proceeding with the {@link #put} operation. Note that a
   ...
   *     particular entry fails. <b>Warning:</b> the bimap may be left with an
   *     indeterminate number of entries from {@code map} having been added.
   */
